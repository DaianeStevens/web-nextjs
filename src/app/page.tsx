...
// TypeScript + JSX = TSX
// JSX = JavaScript + XML
//  XML no final das contas é o HTML

// import { Button } from '@/components/Button'
//  Layout Shift - quando carrega a fonte normal e depois de um segundo carrega a fonte correta
    ...
    <main className="grid min-h-screen grid-cols-2 ">
      ...
      <div className="flex flex-col bg-[url(../assets/bg-starts.svg)] bg-cover p-16">
        <div className="flex flex-1 items-center justify-center">
          <p className="leading-relaxedd w-[360px] text-center">
